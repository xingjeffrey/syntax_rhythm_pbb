...
def indv_barcode(indv_df, time_resolution=0.02, label="labels", pal="tab20"):
    ...
    for phrase in tqdm(indv_df.phrase_nb.unique(), leave=False):
        ...
        start_times = wav_df.motif_strt.values - wav_df.motif_strt.values[0]
        stop_times = wav_df.motif_end.values - wav_df.motif_strt.values[0]
